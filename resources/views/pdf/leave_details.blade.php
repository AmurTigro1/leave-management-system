    ...
    <div class="pdf-body">
        ...
        <div class="overall-body">
            ...
            <div class="head-middle-body">
                <p class="first2">3. DATE OF FILING: <span
                        class="underline">{{ \Carbon\Carbon::parse($leave->date_filing)->format('F d, Y') }}</span></p>
            ...
            <div class="new-class2">
                <div class="middle-part">
                    ...
                    <p class="info"><span class="leave-type">
                        ...
                        Vacation Leave <span class="additional-detail"> (Sec. 51, Rule XVI, Omnibus Rules Implementing
                            E.O. No. 292)</span></p>
                    <p class="info2"><span class="leave-type">
                        ...
                        Mandatory/Forced Leave <span class="info-3"> (Sec. 51, Rule XVI, Omnibus Rules Implementing E.O.
                            No. 292)</span></p>
                    <p class="info2"><span class="leave-type">
                        ...
                        Sick Leave <span class="additional-detail"> (Sec. 43, Rule XVI, Omnibus Rules Implementing E.O.
                            No. 292)</span></p>
                    <p class="info2"><span class="leave-type">
                        ...
                        Maternity Leave<span class="additional-detail"> (R.A No. 11210/IRR Issued by CSC, DOLE and
                            SSS)</span></p>
                    <p class="info2"><span class="leave-type">
                        ...
                        Paternity Leave<span class="additional-detail"> (R.A 8187/CSC MC No. 71, s. 1998, as
                            amended)</span></p>
                    <p class="info3"><span class="leave-type">
                        ...
                        Special Privilege Leave<span class="info-3"> (Sec. 21, Rule XVI, Omnibus Rules Implementing E.O.
                            No. 292)</span></p>
                    <p class="info2"><span class="leave-type">
                        ...
                        Solo Parent Leave<span class="additional-detail"> (R.A No. 8972/CSC MC No. 8, s. 2004)</span>
                    </p>
                    <p class="info2"><span class="leave-type">
                        ...
                        Study Leave<span class="additional-detail"> (Sec. 68, Rule XVL, Omnibus Rules Implementing E.O.
                            No. 292)</span></p>
                    <p class="info2"><span class="leave-type">
                        ...
                        10-Day VAWC Leave<span class="additional-detail"> (R.A No. 9262/CSC MC No. 15, s. 2005)</span>
                    </p>
                    <p class="info2"><span class="leave-type">
                        ...
                        Rehabilitation Privilege<span class="info-2"> (Sec. 55, Rule XVL, Omnibus Rules Implementing
                            E.O. No. 292)</span></p>
                    <p class="info2"><span class="leave-type">
                        ...
                        Special Leave Benefits for Women<span class="additional-detail"> (R.A No. 9710/CSC MC No. 25,
                            s. 2010)</span></p>
                    <p class="info2"><span class="leave-type">
                        ...
                        Special Emergency (Calamity) Leave<span class="additional-detail"> (CSC MC No. 2, s. 2012, as
                            amended)</span></p>
                    <p class="info2"><span class="leave-type">
                        ...
                        Adoption Leave<span class="additional-detail"> (R.A No. 8552)</span></p>
                    <p class="info2"><span class="leave-type">
                            @if ($leave->leave_type == 'Wellness Leave')
                                <img src="{{ public_path('img/check.jpg') }}" width="18" height="10">
                            @endif
                        </span>Wellness Leave<span class="additional-detail"> (CSC MC No. 01, s. 2026)</span></p>
            ...
            <div class="bottom-part">
                ...
                <p class="fill-in-2"><span
                        class="capitalize">{{ \Carbon\Carbon::parse($leave->start_date)->format('F d, Y') }} -
                        {{ \Carbon\Carbon::parse($leave->end_date)->format('F d, Y') }}</span></p>
            </div>
            <div class="middle-part2">
            ...
            <div class="last-part">
                ...
                @if ($leave->days_applied > 10)
                    @foreach ($officials as $official)
                        <p class="last-sign">________<span class="underline">{{ $official->hr_name }}</span>________
                        </p>
                    @endforeach
                @else
                    <p class="last-sign">________<span class="underline">{{ $hr->first_name }}
                            {{ strtoupper(substr($hr->middle_name, 0, 1)) }}. {{ $hr->last_name }}</span>________</p>
                @endif
            ...
            <div class="last-part3">
                ...
                @if ($leave->days_applied > 10)
                    @foreach ($officials as $official)
                        <p class="last-sign2">________<span class="underline">{{ $official->hr_name }}</span>________
                        </p>
                    @endforeach
                @else
                    <p class="last-sign2">________<span class="underline">{{ $hr->first_name }}
                            {{ strtoupper(substr($hr->middle_name, 0, 1)) }}. {{ $hr->last_name }}</span>________</p>
                @endif
            ...
            <div class="final-part">
                ...
                <div class="final-list">
                    <p class="list01">____<span class="underline">{{ $leave->approved_days_with_pay }}</span>____
                        days with pay</p>
                    <p class="list01">____<span class="underline">{{ $leave->approved_days_without_pay }}</span>____
                        days without pay</p>
                ...
                @if ($leave->days_applied > 10)
                    @foreach ($officials as $official)
                        <p class="final-sign">____________<span
                                class="underline">{{ $official->supervisor_name }}</span>____________</p>
                    @endforeach
                @else
                    <p class="final-sign">____________<span class="underline">{{ $supervisor->first_name }}
                            {{ strtoupper(substr($supervisor->middle_name, 0, 1)) }}.
                            {{ $supervisor->last_name }}</span>____________</p>
                @endif
