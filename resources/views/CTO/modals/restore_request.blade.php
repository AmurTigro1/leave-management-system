                ...
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-green-100 text-sm mt-1">
                            Confirm to restore this previously canceled request.
                        </p>
                    </div>
...
<script>
    function openRestoreCtoModal(id) {
        document.getElementById(`restoreCtoModal${id}`).classList.remove("hidden");
    }

    function closeRestoreCtoModal(id) {
        document.getElementById(`restoreCtoModal${id}`).classList.add("hidden");
    }

    document.addEventListener('click', function (event) {
        document.querySelectorAll('[id^="restoreCtoModal"]').forEach(modal => {
