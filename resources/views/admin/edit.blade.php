...
<div class="max-w-6xl mx-auto p-6rounded-lg mt-4">
    ...
    <a href="{{ route('admin.my_requests') }}" class="text-blue-600 hover:text-blue-800 text-sm flex items-center mb-4 transition-transform duration-300 hover:translate-x-2">
...
@endif
    ...
    <!-- Leave Request Form -->
    <form method="POST" action="{{ route('admin.leave_update', $leave->id) }}"  enctype="multipart/form-data" class=" p-4 rounded-lg">
        @csrf
        @method('PUT')
