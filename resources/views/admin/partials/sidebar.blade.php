    ...
    <div x-cloak :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <aside class="w-64 bg-gray-50 h-screen shadow-md fixed">
            ...
            <nav class="mt-6 space-y-2 m-4 text-gray-600">
                ...
                <a href="{{ route('employee-balances.index') }}" class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('employee-balances.index') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="relative">
                    ...
                    <div class="absolute left-0 top-full hidden peer-checked:flex flex-col w-48 mt-1 bg-white border border-gray-300 rounded-md shadow-lg z-20">
                        <a href="{{ route('admin.make_leave_request') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            Leave Request
                        </a>
                        <a href="{{ route('admin.make_cto_request') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            CTO Request
                        </a>
                    </div>
                </div>
                ...
                <div class="relative">
                    ...
                    <div class="absolute left-0 top-full hidden peer-checked:flex flex-col w-48 mt-1 bg-white border border-gray-300 rounded-md shadow-lg z-10">
                        ...
                        <a href="{{ route('admin.cto_requests') }}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            My CTO Requests
                        </a>
                ...
                <a href="{{ route('admin.on_leave') }}" class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('admin.on_leave') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
