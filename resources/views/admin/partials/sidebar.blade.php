...
>
    ...
    <div x-show="isSidebarOpen" x-transition class="flex-1 p-4 space-y-2 text-gray-600 bg-gray-50">
        ...
        <a href="{{ route('admin.requests') }}" class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('admin.requests', 'admin.leave_details') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
