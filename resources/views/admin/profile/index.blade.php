            ...
            <div class="flex justify-between items-center">
                ...
                <div class="relative mr-[15px]">
                    ...
                    <div class="absolute right-0 top-full hidden peer-checked:flex flex-col w-[180px] bg-white border border-gray-300 rounded-md shadow-lg">
                        <a href="{{route('admin.profile.partials.update-profile-information-form')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 flex justify-between items-center">
                            <div class="flex">
                        ...
                        <a href="{{route('admin.profile.partials.update-password-form')}}" class="block px-4 py-2 text-gray-700 hover:bg-gray-100 flex justify-between items-center">
                            <div class="flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
