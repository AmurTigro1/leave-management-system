            ...
            <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                <div class="flex items-center space-x-4">
                    <a href="{{ route('admin.cto_requests') }}"
                        class="p-2 rounded-full bg-white shadow-sm hover:bg-gray-50 transition duration-200">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-gray-50 p-4 rounded-lg border border-gray-100">
                    ...
                    <p class="mt-1 text-lg font-medium text-gray-900">
                        {{ $overtime->user->position ?? 'No position provided.' }}</p>
                </div>
            ...
            <div class="space-y-4">
                ...
                @if ($overtime->status === 'rejected')
                    <div class="bg-red-50 p-5 rounded-lg border border-red-100">
                        ...
                        <p class="text-red-700">{{ $overtime->disapproval_reason ?: 'No disapproval reason provided.' }}
                        </p>
                    </div>
                @endif
            </div>
            ...
            <div class="bg-indigo-50 p-5 rounded-lg border border-indigo-100">
                <div class="flex items-start">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="mt-1 text-indigo-700">Contact our HR department for any questions or assistance regarding
                            your overtime.</p>
                    </div>
                </div>
            </div>
