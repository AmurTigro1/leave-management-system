    ...
    <div class="max-w-6xl mx-auto p-6rounded-lg shadow-lg animate-fade-in">
        ...
        @if (session('success'))
            <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3000)"
                class="p-4 mb-4 text-green-700 bg-green-100 border border-green-500 rounded">
                {{ session('success') }}
            </div>
        @endif
        ...
        @if ($errors->any())
            <div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 3000)"
                class="p-4 mb-4 text-red-700 bg-red-100 border border-red-500 rounded">
                <ul>
        ...
        <!-- Leave Request Form -->
        <form method="POST" action="{{ route('admin-request.leave') }}" class=" p-4 rounded-lg"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="p-3 sm:p-4 bg-blue-50 border-l-4 border-blue-400 rounded-md shadow-sm">
                        <div class="flex items-start">
                            ...
                            <div class="ml-3 flex-1 min-w-0">
                                ...
                                <div class="mt-2">
                                    <button type="button"
                                        onclick="document.getElementById('info_message').classList.add('hidden')"
                                        class="text-blue-700 hover:text-blue-600 text-sm font-medium focus:outline-none">
                                        Dismiss
                                    </button>
                                </div>
                            </div>
                ...
                <div>
                    ...
                    <select name="leave_type" id="leave_type" class="mt-1 w-full p-2 border rounded"
                        ...
                        <option value="Mandatory Leave">Mandatory/Forced Leave (Sec. 25, Rule XVL, Omnibus Rules
                            Implementing E.O. No. 292)</option>
                        <option value="Sick Leave">Sick Leave (Sec. 43, Rule XVI, Omnibus Rules Implementing E.O. No. 292)
                        </option>
                        @if ($gender == 'female')
                            <option value="Maternity Leave">Maternity Leave (R.A. No. 11210/IRR issued by CSC, DOLE and SSS)
                            </option>
                        @endif
                        @if ($gender == 'male')
                            <option value="Paternity Leave">Paternity Leave (R.A. 8187/CSC MC No. 71, s. 1998, as amended)
                            </option>
                        @endif
                        <option value="Special Privilege Leave">Special Privilege Leave (Sec. 21, Rule XVI, Omnibus Rules
                            Implementing E.O. No. 292)</option>
                        <option value="Solo Parent Leave">Solo Parent Leave (R.A No. 8972/CSC MC No. 8, s. 2004)</option>
                        <option value="Study Leave">Study Leave (Sec. 68, Rule XVL, Omnibus Rules Implementing E.O. No. 292)
                        </option>
                        @if ($gender == 'female')
                            <option value="10-Day VAWC Leave">10-Day VAWC Leave (R.A. No. 9262/CSC MC No. 15, s. 2005)
                            </option>
                        @endif
                        <option value="Rehabilitation Privilege">Rehabilitation Privilege (Sec. 55, Rule XVL, Omnibus Rules
                            Implementing E.O. No. 292)</option>
                        @if ($gender == 'female')
                            <option value="Special Leave Benefits for Women Leave">Special Leave Benefits for Women (R>A.
                                No. 9710/CSC MC No. 25, s. 2010)</option>
                        @endif
                        <option value="Special Emergency Leave">Special Emergency (Calamity) Leave (CSC MC No. 2, s. 2012,
                            as amended)</option>
                ...
                <div>
                    ...
                    <input type="date" name="start_date" id="start_date" class="mt-1 w-full p-2 border rounded"
                ...
                <div class="">
                    ...
                    <input type="number" name="days_applied" id="days_applied" class="w-full border p-2 rounded"
                        min="0" required placeholder="Enter Days Applied" readonly>
                </div>
                ...
                <div id="file_upload_section" class="hidden">
                    <div>
                        ...
                        <div class="border-2 border-dashed border-gray-300 rounded-lg p-6 text-center hover:border-blue-400 transition-colors cursor-pointer"
                            ...
                            <label for="leave_files"
                                class="mt-4 px-4 py-2 text-blue-700 rounded-md text-sm font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer">
                                Select Files
                            </label>
                            <input type="file" name="leave_files[]" id="leave_files" multiple class="hidden"
                                accept="image/*,.pdf">
                        </div>
            ...
            <div id="vacation_options" class="hidden space-y-3">
                <div>
                    <label><input type="checkbox" name="within_philippines" value="1"> Within the
                        Philippines</label>
                ...
                <div>
                    ...
                    <input type="text" name="abroad_details" class="w-full border rounded p-1 mt-1"
                        placeholder="Specify">
