    ...
    <div x-cloak :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <aside class="w-64 bg-gray-50 h-screen shadow-md fixed">
            ...
            <nav class="mt-6 space-y-2 m-4 text-gray-600">
                ...
                <!-- Submit DTR for Overtime -->
                <a href="{{ route('employee.submit_dtr') }}" class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('employee.submit_dtr') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M4 4a2 2 0 012-2h4.586A2 2 0 0112 2.586L15.414 6A2 2 0 0116 7.414V16a2 2 0 01-2 2H6a2 2 0 01-2-2V4zm2 6a1 1 0 011-1h6a1 1 0 110 2H7a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H7z" clip-rule="evenodd" />
                    </svg>
                    <span>Submit DTR for Overtime</span>
                </a>

                <!-- Holidays Link -->
                <a href="{{ route('hr.holiday.calendar') }}" class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('holiday.calendar') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
