        ...
        <aside class="w-64 bg-gray-50 h-screen shadow-md fixed">
            ...
            <nav class="mt-6 space-y-2 m-4 text-gray-600">
                ...
                <a href="{{ route('employee.leaderboard') }}"
                    class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('employee.leaderboard') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <a href="{{ route('cto.overtime_request') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            CTO Request
                        </a>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <a href="{{ route('cto.overtime_list') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            CTO List
                        </a>
                    </div>
                ...
                <a href="{{ route('employee.holiday.calendar') }}"
                    class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('employee.holiday.calendar') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd"
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.addEventListener('click', function(event) {
            const isClickInsideDropdown1 = event.target.closest('.relative') === document.querySelector(
                '#dropdown-toggle1').closest('.relative');
            const isClickInsideDropdown2 = event.target.closest('.relative') === document.querySelector(
                '#dropdown-toggle2').closest('.relative');
