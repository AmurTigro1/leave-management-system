...
<div class="h-screen flex">
    ...
    <div class="w-1/2 flex flex-col justify-center px-24">
        <img src="/img/dilg-main.png" alt="DILG Logo" class="h-[100px] w-[100px] mb-2">
    ...
    <div class="w-1/2 flex items-center justify-center relative">
        ...
        <div class="absolute mt-[-90px] animate-bounce bg-primary text-white text-sm px-4 py-2 rounded-lg shadow-lg">
            📊 Efficient Tracking
        </div>
    </div>
</div>
