...
<div class="w-full p-3 rounded-xl shadow-md">
    ...
    <div class="px-4 mt-4">
        <div class="flex flex-col md:flex-row justify-between items-center">
            ...
            <a class="text-blue-600 mt-2 md:mt-0" href="{{route('employee.profile.index')}}">
...
<div class="p-3 rounded-xl mt-2 flex flex-col md:flex-row justify-center items-start animate-fade-in">
    <div class="flex-1 p-4">
        ...
        <form method="post" action="{{ route('employee-profile.update') }}" class="mt-6 space-y-4">
            @csrf
            @method('patch')
...
<div class="p-3 rounded-xl mt-4">
    <div class="flex flex-col md:flex-row items-start">
        <div class="flex-1 p-4">
            ...
            <form method="post" action="{{ route('employee-email.update') }}" class="space-y-4">
                @csrf
                @method('patch')
