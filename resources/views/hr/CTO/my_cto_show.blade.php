    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 px-6 py-5 border-b border-gray-200">
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div class="flex items-center space-x-4">
                <a href="{{ route('hr.cto_requests') }}" class="p-2 rounded-full bg-white shadow-sm hover:bg-gray-50 transition duration-200">
            ...
            <div class="flex space-x-3">
                <a href="{{ route('hr.overtime.viewPdf', $overtime->id) }}" target="_blank" 
