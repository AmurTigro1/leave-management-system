    ...
    <div class="ml-[25px] py-2">
        <div class="mt-3 space-y-3">
            <div class="flex justify-between items-center">
                ...
                <div class="mr-3">
                    <a class="text-blue-600" href="{{route('hr.profile.index')}}"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go back</a>
                </div>
            </div>
        </div>
    </div>
...
<div class="p-3 rounded-xl mt-2 flex justify-start items-center animate-fade-in">
    <div class="mr-4">
        ...
        <div class="ml-[25px]">
            ...
            <form method="post" action="{{ route('hr-profile.update') }}" class="mt-6 space-y-6">
                @csrf
                @method('patch')
    ...
    <div class="flex justify-start items-center">
        <div class="w-[45%]">
            ...
            <div class="ml-[25px]">
                ...
                <form method="post" action="{{ route('hr-email.update') }}" class="space-y-6">
                    @csrf
                    @method('patch')
