...
<div class="container mx-auto px-4 py-8 max-w-2xl">
    <div class="bg-white shadow-md rounded-lg p-6">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Edit Holiday</h1>
        ...
        <form action="{{ route('hr.holidays.update', $holiday->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="name" name="name" value="{{ old('name', $holiday->name) }}" 
            ...
            <div class="mb-4">
                ...
                <input type="date" id="date" name="date" value="{{ old('date', $holiday->date->format('Y-m-d')) }}" 
            ...
            <div class="mb-6">
                <div class="flex items-center">
                    <input type="checkbox" id="repeats_annually" name="repeats_annually" 
