                ...
                <div class="relative">
                    <button id="hr-notification-button" class="p-2 rounded-full bg-gray-100 relative">
                        ...
                        @if(auth()->user()->unreadNotifications->count() > 0)
                            <span id="hr-notification-badge" class="absolute -top-1 -right-1 bg-red-500 text-white px-2 py-0.5 text-xs rounded-full">
                    ...
                    <div id="hr-notification-container" class="absolute right-0 bg-white shadow-lg rounded-lg sm:rounded-xl border border-gray-200 p-3 sm:p-4 mt-2 w-56 sm:w-64 md:w-72 hidden z-50">
                        ...
                        <div class="mt-3 flex gap-2 justify-between border-t border-gray-100 pt-3">
                            <button id="hr-mark-all-as-read" class="text-gray-500 hover:text-gray-700 text-xs sm:text-sm">Mark all as read</button>
                            <button id="hr-delete-all-notifications" class="text-gray-500 hover:text-gray-700 text-xs sm:text-sm">Delete All</button>
                        </div>
                    </div>
                </div>
