@php
    $pendingLeaveCount = App\Models\Leave::where('status', 'pending')->where('admin_status', 'approved')->count();
        ...
        <aside class="w-64 bg-gray-50 h-screen shadow-md fixed">
            ...
            <nav class="mt-6 space-y-2 m-4 text-gray-600">
                <a href="{{ route('hr.dashboard') }}"
                    class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('hr.dashboard') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                ...
                <a href="{{ route('hr.leaderboard') }}"
                    class="hover:bg-gray-200 flex items-center p-2 rounded-md {{ request()->routeIs('hr.leaderboard') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                ...
                <a href="{{ route('hr.employee-balances.index') }}"
                    class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('hr.employee-balances.index') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <a href="{{ route('hr.make_leave_request') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            Leave Request
                        </a>
                        <a href="{{ route('hr.make_cto_request') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            CTO Request
                        </a>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div
                        ...
                        <a href="{{ route('hr.my_requests') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            My Leave Requests
                        </a>
                        <a href="{{ route('hr.cto_requests') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                            My CTO Requests
                        </a>
                        ...
                        <a href="{{ route('hr.my_untimely_sick_applications') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-gray-100">
                ...
                <a href="{{ route('hr.on_leave') }}"
                    class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('hr.on_leave') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                ...
                <a href="{{ route('hr.users') }}"
                    class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('hr.users') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                        <path
                ...
                <a href="{{ route('hr.holidays.index') }}"
                    class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('hr.holidays.index') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd"
                ...
                <a href="{{ route('hr.holiday.calendar') }}"
                    class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('hr.holiday.calendar') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                        <path
