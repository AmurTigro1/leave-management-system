    ...
    <div x-cloak :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full'"
        ...
        <aside class="w-64 bg-gray-50 h-screen shadow-md fixed">
            ...
            <nav class="mt-6 space-y-2 m-4 text-gray-600">
                ...
                <a href="{{ route('hr.employee-balances.index') }}" class="hover:bg-gray-200 flex items-center p-2 space-x-2 rounded-md {{ request()->routeIs('hr.employee-balances.index') ? 'bg-white shadow-lg' : 'text-gray-500' }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
