<div id="developersModal" tabindex="-1" aria-hidden="true" class="hidden fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black/50 p-2 sm:p-4">
    <div class="relative rounded-lg sm:rounded-xl md:rounded-2xl shadow-xl w-full max-w-5xl max-h-[90vh] overflow-y-auto bg-white border border-gray-200/70 mx-auto">
        <button data-modal-hide="developersModal" class="absolute top-2 right-2 sm:top-3 sm:right-3 z-10 text-gray-500 hover:text-red-500 transition-colors p-1 sm:p-1.5 rounded-lg bg-white/80 backdrop-blur-sm border border-gray-200/60 shadow-xs hover:shadow-sm">
        ...
        <div class="flex flex-col h-auto">
            <div class="w-full p-4 sm:p-5 md:p-6">
                <h3 class="text-lg sm:text-xl md:text-2xl font-bold text-gray-800 mb-3 sm:mb-4">Developers</h3>
                ...
                <div class="mt-4 sm:mt-5 md:mt-6 text-center text-xs sm:text-sm text-gray-500/90 font-medium border-t border-gray-100/50 pt-3 sm:pt-4">
                    Mater Dei College IT Interns © 2025 Student Team
                </div>
            </div>
        </div>
    </div>
