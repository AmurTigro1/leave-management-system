                ...
                <div class="relative">
                    <button id="supervisor-notification-button" class="p-2 rounded-full bg-gray-100 relative">
                        ...
                        @if (auth()->user()->unreadNotifications->count() > 0)
                            <span id="supervisor-notification-badge"
                    ...
                    <div id="supervisor-notification-container"
                        class="absolute right-0 bg-white shadow-lg rounded-lg sm:rounded-xl border border-gray-200 p-3 sm:p-4 mt-2 w-56 sm:w-64 md:w-72 hidden z-50">
                        ...
                        <div class="mt-3 flex gap-2 justify-between border-t border-gray-100 pt-3">
                            <button id="supervisor-mark-all-as-read"
                                class="text-gray-500 hover:text-gray-700 text-xs sm:text-sm">Mark all as read</button>
                            <button id="supervisor-delete-all-notifications"
...
<script>
    document.addEventListener("DOMContentLoaded", () => {
        ...
        document.addEventListener("click", function(event) {
            if (!supervisorNotificationButton.contains(event.target) && !supervisorNotificationContainer
