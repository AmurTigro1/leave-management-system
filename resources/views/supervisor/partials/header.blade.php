        ...
        <nav class="flex items-center space-x-6">
            <div class="flex flex-row text-gray-600 space-x-2">
                ...
                <div class="relative">
                    ...
                    <!-- Notification Dropdown for HR -->
                    <div id="supervisor-notification-container" class="absolute right-0 bg-white shadow-lg rounded-xl border border-gray-200 p-4 mt-2 w-64 hidden z-10">
                        <h3 class="text-gray-700 font-semibold mb-2">Supervisor Notifications</h3>
                        ...
                        <div class="mt-3 flex gap-2 justify-between">
                            <button id="supervisor-mark-all-as-read" class="text-gray-500 text-xs">Mark all as read</button>
                            <button id="supervisor-delete-all-notifications" class="text-gray-500 text-xs">Delete All</button>
                        </div>
                    </div>
                </div>
