...
<div class="container mx-auto px-4 py-8 max-w-7xl">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-8 gap-4">
        <div>
            ...
            <p class="text-gray-600 mt-1">View and manage your organization's holidays</p>
        </div>
    </div>
<!-- Stats Cards -->
<div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-3xl font-semibold text-gray-900">{{ $groupedHolidays->flatten()->count() }}</p>
            </div>
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-500">Regular Holiday</p>
                <p class="mt-1 text-3xl font-semibold text-gray-900">{{ $groupedHolidays->flatten()->where('type', 'regular')->count() }}</p>
            </div>
            <div class="p-3 rounded-lg text-green-600">
                <!-- Briefcase/Work Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-500">Special Non-Working Day</p>
                <p class="mt-1 text-3xl font-semibold text-gray-900">{{ $groupedHolidays->flatten()->where('type', 'special')->count() }}</p>
            </div>
            <div class="p-3 rounded-lg bg-amber-50 text-amber-600">
                <!-- Palm Tree with Sun Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <!-- Sun rays -->
    ...
    <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
        <div class="flex items-center justify-between">
            <div>
                <p class="text-sm font-medium text-gray-500">National Holiday</p>
                <p class="mt-1 text-3xl font-semibold text-gray-900">{{ $groupedHolidays->flatten()->where('type', 'national')->count() }}</p>
            </div>
            <div class="p-3 rounded-lg text-red-600">
                <!-- Philippines Flag Icon -->
                <svg xmlns="http://www.w3.org/2000/svg" class="h-8 w-8" viewBox="0 0 512 512" fill="none">
...
<div class="bg-white rounded-xl shadow-md overflow-hidden mb-8 border border-gray-100">
    <div class="bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-4">
        <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-white">Calendar Overview</h2>
            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-blue-700 text-white">
                {{ $selectedYear }}
            </span>
        </div>
    </div>
                    ...
                    <div class="p-3">
                        ...
                        <div class="grid grid-cols-7 gap-1 relative overflow-visible">
                            ...
                            @for($day = 1; $day <= $daysInMonth; $day++)
                                ...
                                <div 
                                    class="relative group h-10 flex items-center justify-center text-sm font-medium
                                ...
                                >
                                    ...
                                    @if($hasHoliday)
                                        <span class="absolute bottom-1 right-1 w-2 h-2 rounded-full bg-blue-500"></span>
                                    ...
                                    <div x-show="showTooltip" 
                                        class="absolute z-10 bottom-10 left-1/2 transform -translate-x-1/2 w-48 bg-black text-white text-xs rounded-md p-2 shadow-md"
                                        style="display: none;"
                                    >
    ...
    <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
        <div class="bg-gradient-to-r from-blue-600 to-blue-500 px-6 py-4">
            <h2 class="text-xl font-semibold text-white">Holiday List</h2>
        </div>
        <div class="p-6">
            @if($groupedHolidays->isEmpty())
                <div class="text-center py-8">
                    ...
                    <h3 class="mt-2 text-lg font-medium text-gray-900">No holidays found</h3>
                    <p class="mt-1 text-gray-500">Add holidays to see them displayed here.</p>
                </div>
            @else
                <div class="space-y-8">
